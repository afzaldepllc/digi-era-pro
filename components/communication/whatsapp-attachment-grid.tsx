...
export const WhatsAppAttachmentGrid = memo(function WhatsAppAttachmentGrid({
        ...
        {isMedia && attachment.file_url ? (
          <>
            ...
            {category === 'video' && (
              <>
                ...
                <div className="absolute bottom-2 left-2 px-1.5 py-0.5 bg-black/70 rounded text-xs text-white flex items-center gap-1">
          ...
          <div className="aspect-square bg-muted flex flex-col items-center justify-center p-4">
            {(() => {
              ...
              return <Icon className="h-10 w-10 text-muted-foreground mb-2" />
            })()}
  ...
  return (
    <>
      <div className={cn(
        "grid gap-1 rounded-lg overflow-hidden max-w-md",
        getGridClass(),
        className
      )}>
